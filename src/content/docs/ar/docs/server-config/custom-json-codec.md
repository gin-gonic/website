---
title: "مُرمّز JSON مخصص في وقت التشغيل"
sidebar:
  order: 2
---

يدعم Gin منطق تسلسل وإلغاء تسلسل JSON مخصص بدون استخدام علامات الترجمة.

1. حدد هيكلاً مخصصاً ينفّذ واجهة `json.Core`.
2. قبل بدء المحرك، عيّن القيم إلى `json.API` باستخدام الهيكل المخصص.
