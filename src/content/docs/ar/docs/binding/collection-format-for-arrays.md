---
title: "تنسيق المجموعات للمصفوفات"
sidebar:
  order: 6
---

يمكنك التحكم في كيفية تقسيم Gin لقيم القوائم لحقول الشرائح/المصفوفات باستخدام علامة هيكل `collection_format` مع ربط النماذج.

التنسيقات المدعومة (v1.11+):

- multi (الافتراضي): مفاتيح متكررة أو قيم مفصولة بفواصل
- csv: قيم مفصولة بفواصل
- ssv: قيم مفصولة بمسافات
- tsv: قيم مفصولة بتبويب
- pipes: قيم مفصولة بأنبوب
...
- لتنسيقي `multi` و`csv`، افصل القيم الافتراضية بفواصل منقوطة: `default=1;2;3`.
- لتنسيقات `ssv` و`tsv` و`pipes`، استخدم الفاصل الطبيعي في القيمة الافتراضية.

انظر أيضاً: مثال "القيم الافتراضية لحقول النماذج".
