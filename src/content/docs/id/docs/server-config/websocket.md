---
title: "Dukungan WebSocket"
sidebar:
  order: 9
---

Gin tidak menyertakan implementasi WebSocket bawaan, tetapi terintegrasi dengan mulus dengan paket [gorilla/websocket](https://github.com/gorilla/websocket). Karena handler Gin menerima `http.ResponseWriter` dan `*http.Request` yang mendasari, Anda dapat meng-upgrade rute Gin mana pun ke koneksi WebSocket dengan usaha minimal.
...
- [Konfigurasi HTTP kustom](/id/docs/server-config/custom-http-config/) -- Menyesuaikan server HTTP yang mendasari
