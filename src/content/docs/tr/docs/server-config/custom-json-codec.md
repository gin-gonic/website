---
title: "Çalışma zamanında özel JSON codec'i"
sidebar:
  order: 2
---

Gin, derleme etiketleri kullanmadan özel JSON serileştirme ve seriyi kaldırma mantığını destekler.

1. `json.Core` arayüzünü uygulayan özel bir struct tanımlayın.
2. Motorunuz başlamadan önce, özel struct'ı kullanarak `json.API`'ye değerler atayın.
