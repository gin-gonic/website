...
> **Datos actualizados:** Estos benchmarks fueron recopilados en marzo de 2026 usando Gin v1.12.0 y Go 1.25.8. Para resultados de benchmarks actualizados, consulte el repositorio [go-http-routing-benchmark](https://github.com/gin-gonic/go-http-routing-benchmark).

## Benchmarks de rendimiento del framework web Gin

Los benchmarks ayudan a los desarrolladores a evaluar la eficiencia y el uso de recursos de las bibliotecas de enrutadores HTTP en Go. Esta página resume las mediciones de muchos frameworks populares, para que pueda comparar fácilmente su velocidad y consumo de memoria.
...
Gin utiliza un fork optimizado de [HttpRouter](https://github.com/julienschmidt/httprouter) para enrutamiento de alto rendimiento.

Si desea ver más casos de prueba, puede consultar [todos los benchmarks aquí](https://github.com/gin-gonic/gin/blob/master/BENCHMARKS.md).
...
Puede usar estos resultados para una comparación directa entre Gin y enrutadores alternativos.
...
- **Repeticiones**: Total de repeticiones logradas en tiempo constante. Números más altos significan mayor confianza en los resultados.
...
Para preguntas o contribuciones, consulte nuestro [repositorio de GitHub](https://github.com/gin-gonic/gin).
