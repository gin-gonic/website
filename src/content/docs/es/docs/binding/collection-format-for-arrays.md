...
Puedes controlar cómo Gin divide los valores de lista para campos de tipo slice/array usando la etiqueta de struct `collection_format` con el enlace de formularios.
...
Ver también: ejemplo de "Valores predeterminados para campos de formulario".
