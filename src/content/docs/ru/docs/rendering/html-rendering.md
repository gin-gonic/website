...
Gin использует пакет [html/template](https://pkg.go.dev/html/template) для рендеринга HTML.
Для получения дополнительной информации об использовании, включая доступные плейсхолдеры, смотрите документацию [text/template](https://pkg.go.dev/text/template).
...
Подробный [пример кода](https://github.com/gin-gonic/examples/tree/master/template).
