...
Если одно из полей структуры само является структурой (вложенная структура), поля этой структуры также должны быть украшены `binding:"required"` для правильной валидации.
