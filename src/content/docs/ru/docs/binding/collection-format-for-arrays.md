---
title: "Формат коллекций для массивов"
sidebar:
  order: 6
---

Вы можете контролировать, как Gin разделяет значения списков для полей срезов/массивов, используя тег структуры `collection_format` при привязке форм.
...
Смотрите также: пример «Значения по умолчанию для полей формы».
